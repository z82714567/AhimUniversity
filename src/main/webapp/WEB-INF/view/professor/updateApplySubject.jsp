	...
	<div class="container mb-5">
		<div class="row">
			...
			<div class="col-md-10 p-5">
				<form action="/professor/update-list/" method="post"
						...
						<div class="card-body">
							<div class="mb-3">
								<label for="name" class="form-label">강의명</label> <input
									...
									placeholder="강의명을 입력하세요" autocomplete="off" value="">
							</div>
								...
								<div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="semester"
											id="1학기" value="1"
											>
										<label class="form-check-label" for="1학기">1학기</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="semester"
											id="2학기" value="2"
											>
										<label class="form-check-label" for="2학기">2학기</label>
									</div>
								</div>
							</div>
								...
								<div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="subDay"
											id="mo" value="월"
											>
										<label class="form-check-label" for="mo">월</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="subDay"
											id="tu" value="화"
											>
										<label class="form-check-label" for="tu">화</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="subDay"
											id="we" value="수"
											>
										<label class="form-check-label" for="we">수</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="subDay"
											id="th" value="목"
											>
										<label class="form-check-label" for="th">목</label>
									</div>
									<div class="form-check form-check-inline">
										<input class="form-check-input" type="radio" name="subDay"
											id="fr" value="금"
											>
										<label class="form-check-label" for="fr">금</label>
									</div>
								</div>
							</div>
